...
int main(){
    ...
    vector<double> rmsSlope = rmspropslope(x,y,input,learningRate,decay,decRate,setConst,itr);
    for(size_t elements = 0; elements < rmsSlope.size(); elements++){
        cout<<rmsSlope[elements]<<endl;
    }
