...
void kmeansclust(vector<double> &x, vector<double> &y, double setCentroidX1, double setCentroidY1, double setCentroidX2, double setCentroidY2, int n){
...
int main(){
    vector<double> x = {2,3,3,5,6,6};
    vector<double> y = {3,3,4,6,5,6}; 
    // Centroid: Random Initialization
    double setCentroidX1 = x[0];
    double setCentroidY1 = y[0];
