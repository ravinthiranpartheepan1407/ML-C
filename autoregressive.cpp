...
int main(){
    vector<double> x = {100,105,110,108,112,115,118,120,125,130};
    double t=10;
    double stop = 20;
    vector<double> result = autoregressive(x,t,stop);
    for(size_t elements = 0; elements < result.size(); elements++){
